...
class source_file_to_mysql:
    ...
    def ConnectMysql(self):
        MysqlDatabase = pymysql.connect(self._MysqlHost["host"], self._MysqlHost["user"], self._MysqlHost["password"])
        self._MysqlCursor=MysqlDatabase.cursor()
    ...
    def ReadFileRootPath(self,source_root_path):
        ...
        #源文件读取时的路径更新方案····
        # for parent1, database_list1, filenames1 in os.walk(self._SourceFileRootPath):
        #     #print(self._SourceFileRootPath)
        #     print(parent1,database_list1,filenames1)
